        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComponentCode = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 5, 8, 9, 0, 0, DateTimeKind.Unspecified), "Gaming Beast X", 5, 36, 12.5 },
                    { 2, new DateTime(2026, 4, 15, 13, 30, 0, DateTimeKind.Unspecified), "Office Mini Pro", 12, 24, 4.2 },
                    { 3, new DateTime(2026, 3, 20, 11, 15, 0, DateTimeKind.Unspecified), "Creator Studio Z", 7, 48, 8.9 }
                });
