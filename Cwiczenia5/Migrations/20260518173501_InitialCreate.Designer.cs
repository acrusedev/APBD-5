...
namespace Cwiczenia5.Migrations
{
    ...
    [Migration("20260518173501_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cwiczenia5.Models.Entities.Component", b =>
                {
            ...
            modelBuilder.Entity("Cwiczenia5.Models.Entities.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cwiczenia5.Models.Entities.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cwiczenia5.Models.Entities.Pc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 3, 20, 11, 15, 0, 0, DateTimeKind.Unspecified),
                            Name = "Creator Studio Z",
                            Stock = 7,
                            Warranty = 48,
            ...
            modelBuilder.Entity("Cwiczenia5.Models.Entities.PcComponent", b =>
                {
                    b.Property<int>("PcId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cwiczenia5.Models.Entities.Component", b =>
                {
                    b.HasOne("Cwiczenia5.Models.Entities.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Cwiczenia5.Models.Entities.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("Cwiczenia5.Models.Entities.PcComponent", b =>
                {
                    b.HasOne("Cwiczenia5.Models.Entities.Component", "Component")
                        .WithMany("PcComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Cwiczenia5.Models.Entities.Pc", "Pc")
                        .WithMany("PcComponents")
                        .HasForeignKey("PcId")
